...
# Live Web App:
https://skin-cancer-detection-priyanshi.onrender.com
## Objective
...
- Other Libraries:	NumPy, Pandas, Matplotlib, Scikit-learn, OpenCV
 ## Model Training
- Model: CNN
- Resizing, Normalization, Train-Test Split
- Evaluation Metrics:
- Accuracy
...
git clone: https://github.com/PriyanshiSangwan/skin-cancer-detection
